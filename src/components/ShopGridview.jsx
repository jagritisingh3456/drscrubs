    ...
    <div className="collection-slider-6items gp10 slick-arrow-dots sub-collection section pt-0">
      ...
      <div className="category-item zoomscal-hov">
        <a href="shop-left-sidebar.html" className="category-link clr-none">
          ...
          <div className="details text-center">
            <h4 className="category-title mb-0">Women's</h4>
            <p className="counts">24 Items</p>
          </div>
        </a>
      </div>
      <div className="category-item zoomscal-hov">
        <a href="shop-left-sidebar.html" className="category-link clr-none">
          ...
          <div className="details text-center">
            <h4 className="category-title mb-0">Top</h4>
            <p className="counts">13 Items</p>
          </div>
        </a>
      </div>
      <div className="category-item zoomscal-hov">
        <a href="shop-left-sidebar.html" className="category-link clr-none">
          ...
          <div className="details text-center">
            <h4 className="category-title mb-0">Bottom</h4>
            <p className="counts">26 Items</p>
          </div>
        </a>
      </div>
      <div className="category-item zoomscal-hov">
      ...
      <div className="category-item zoomscal-hov">
        <a href="shop-left-sidebar.html" className="category-link clr-none">
          <div className="zoom-scal zoom-scal-nopb rounded-0">
            <img
              className="rounded-0 blur-up lazyload"
              data-src="assets/images/collection/sub-collection24.jpg"
              src="assets/images/collection/sub-collection24.jpg"
              alt="Jeans"
              title="Jeans"
              width={365}
              height={365}
          ...
          <div className="details text-center">
            <h4 className="category-title mb-0">Jeans</h4>
    ...
    <div className="toolbar toolbar-wrapper shop-toolbar">
      <div className="row align-items-center">
        <div className="col-4 col-sm-2 col-md-4 col-lg-4 text-left filters-toolbar-item d-flex order-1 order-sm-0">
          <button
            type="button"
            className="btn btn-filter text icon anm anm-sliders-hr d-inline-flex me-2 me-lg-3"
          >
            {" "}
            Filter
          </button>
          <div className="filters-item d-flex align-items-center">
            ...
            <div className="grid-options view-mode d-flex">
              ...
              />
              <a
                className="icon-mode mode-grid grid-5 d-xl-block active"
                data-col={5}
              />
            </div>
          </div>
        ...
        <div className="sidebar-tags clearfix">
          ...
          <div className="sidebar-widget filterBox filter-widget product-type">
            ...
            <div className="widget-content filterDD">
              <ul className="clearfix">
                <li>
                  <input type="checkbox" defaultValue="fashion" id="fashion" />
          ...
          <div className="sidebar-widget filterBox filter-widget availability">
            ...
            <div className="widget-content filterDD">
              <ul className="clearfix">
                <li>
                  <input type="checkbox" defaultValue="instock" id="instock" />
