...
function ProductDetails() {
  ...
  <div className="container">
      ...
      <div className="row">
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
          <div className="product-sticky-style">
            {/* Product Horizontal */}
            <div className="product-details-img product-thumb-left-style d-flex justify-content-center">
              {/* Product Thumb */}
              <div className="product-thumb thumb-left">
                <div id="gallery" className="product-thumb-vertical h-100">
                  <a
                    data-image="assets/images/products/product2.jpg"
                    data-zoom-image="assets/images/products/product2.jpg"
                    className="slick-slide slick-cloned active"
                  >
                    <img
                      className="blur-up lazyload rounded-0"
                  ...
                  <a
                    data-image="assets/images/products/product2-1.jpg"
                    data-zoom-image="assets/images/products/product2-1.jpg"
                  ...
                  <a
                    data-image="assets/images/products/product2-2.jpg"
                    data-zoom-image="assets/images/products/product2-2.jpg"
                    className="slick-slide slick-cloned"
                  >
                    <img
                      className="blur-up lazyload rounded-0"
                  ...
                  <a
                    data-image="assets/images/products/product2-3.jpg"
                    data-zoom-image="assets/images/products/product2-3.jpg"
                    className="slick-slide slick-cloned"
                  >
                    <img
                      className="blur-up lazyload rounded-0"
                  ...
                  <a
                    data-image="assets/images/products/product2-4.jpg"
                    data-zoom-image="assets/images/products/product2-4.jpg"
                    className="slick-slide slick-cloned"
                  >
                    <img
                      className="blur-up lazyload rounded-0"
                  ...
                  <a
                    data-image="assets/images/products/product2-5.jpg"
                    data-zoom-image="assets/images/products/product2-5.jpg"
                    className="slick-slide slick-cloned"
                  >
                    <img
                      className="blur-up lazyload rounded-0"
              ...
              {/* End Product Thumb */}
              {/* Product Main */}
              <div className="zoompro-wrap product-zoom-right rounded-0">
                {/* Product Image */}
                <div className="zoompro-span">
                  <img
                    id="zoompro"
                    className="zoompro rounded-0"
                    src="assets/images/products/product2.jpg"
                    data-zoom-image="assets/images/products/product2.jpg"
                    alt="product"
                    width={625}
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
          ...
          <div className="product-single-meta">
            <div className="product-main-subtitle mb-3 d-flex-center">
              <div className="product-labels position-static d-inline-flex">
                <span className="lbl pr-label1 mb-0">Best seller</span>
              </div>
              <span className="label-text ms-2 d-none">in Fashion</span>
            </div>
            <h2 className="product-main-title">Product Layout Style2</h2>
            {/* Product Reviews */}
            ...
            {/* End Product Price */}
            {/* Sort Description */}
            <div className="sort-description mb-3">
            ...
            <div className="product-availability p-0 m-0 mb-3 position-static col-lg-9">
              <div className="lh-1 d-flex justify-content-between">
                <div className="text-sold fw-600">
                  Currently, <strong className="text-link">16</strong> items are
                  in stock!
                </div>
              </div>
            ...
            >
              ...
              <p id="quantity_message" className="ms-2 ps-2 border-start">
                Hurry up! only <span className="items fw-bold">4</span> products
                left in stock!
              </p>
            </div>
            {/* End Product Sold */}
            {/* Product Info */}
            <div
              className="userViewMsg featureText mb-2"
              data-user={20}
              data-time={11000}
            >
            ...
            <div className="product-swatches-option">
              ...
              >
                ...
                <ul className="variants-clr swatches d-flex-center pt-1 clearfix">
                  <li className="swatch x-large available active blue">
                    <span
                      className="swatchLbl"
                  ...
                  <li className="swatch x-large available black">
                    <span
                      className="swatchLbl"
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
          ...
          <div className="product-info">
            <div className="freeShipMsg featureText mb-2">
              <i className="icon anm anm-shield-check-r" />
              <b className="freeShip">1</b> Year Brand Warranty
            </div>
            <div className="freeShipMsg featureText mb-2">
              <i className="icon anm anm-sync-ar" />
              <b className="freeShip">30</b> Day Return Policy
            </div>
            <div className="freeShipMsg featureText mb-3">
              <i className="icon anm anm-podcast-r" />
          ...
          {/* End Product Info */}
          {/* Product Info */}
          <div className="freeShipMsg featureText mt-3" data-price={199}>
          ...
          <div className="shippingMsg featureText mb-0">
            <i className="icon anm anm-clock-r" />
            Estimated Delivery Between <b id="fromDate">Wed, May 1</b> and{" "}
            <b id="toDate">Tue, May 7</b>.
          </div>
          <div className="trustseal-img mt-3 mt-md-4">
            <img
              src="assets/images/icons/powerby-cards.jpg"
              alt="powerby cards"
              width={470}
            />
          </div>
    ...
    >
      ...
      <span className="img">
        <img
          className="rounded-0 rounded-start-0"
    ...
    >
      <span className="img">
        <img
          className="rounded-0 rounded-end-0"
    ...
    <div className="tabs-listing section pb-0">
      <ul className="product-tabs list-unstyled d-flex-wrap border-bottom d-none d-md-flex">
              ...
              <div className="col-12 col-sm-12 col-md-4 col-lg-4">
                <div className="video-popup-content position-relative">
                  <a
                    ...
                    className="popup-video video-button d-flex align-items-center justify-content-center rounded-0"
                    data-bs-toggle="modal"
                    data-bs-target="#productVideo_modal"
                    title="View Video"
                  >
                    <img
                      className="rounded-0 w-100 d-block blur-up lazyload"
                      data-src="assets/images/content/product-detail-img-1.jpg"
                      src="assets/images/content/product-detail-img-1.jpg"
                      alt="image"
                      width={550}
                      height={660}
                    />
