        ...
        <div className="error-content py-4">
          ...
          >
            <div className="input-group">
              ...
              <button
                type="submit"
                className="action d-flex-justify-center btn btn-secondary"
              >
                <i className="icon anm anm-search-l" />
              </button>
            </div>
          </form>
          <p className="same-width-btn">
            <a href="index.html" className="btn btn-secondary btn-lg mb-2 mx-3">
              Go Back
            </a>
            <a href="shop-left-sidebar.html" className="btn btn-lg mb-2">
              Continue shopping
            </a>
          </p>
        </div>
